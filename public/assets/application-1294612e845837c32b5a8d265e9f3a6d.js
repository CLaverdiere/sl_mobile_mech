...
(function() {
  $(document).ready(function() {
    ...
    return $(document).on('click', '.appointment-container', function() {
      return $(".extra-info", this).toggle('fast');
    });
  });
...
(function() {
  $(function() {
    $(document).on('mouseenter', 'a', function() {
      return $(this).addClass("hover-color");
    });
    return $(document).on('mouseleave', 'a', function() {
      return $(this).removeClass("hover-color");
    });
  });
